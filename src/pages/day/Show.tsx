    ...
    <>{isLoading ? <div className='h-screen flex items-center justify-center w-full'><Spinner size='lg' color='warning' /></div>
      ...
      (showDay && <div className='w-full'>
        ...
        <div className='w-full grid grid-cols-1 md:grid-cols-2'>
          <div className='p-3 bg-white dark:bg-slate-900 rounded-xl'>left</div>
          <div className='p-3 bg-white dark:bg-slate-900 rounded-xl'>right</div>
        </div>
      </div>)}</>
  )
}
